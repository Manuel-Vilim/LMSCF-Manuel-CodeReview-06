...
var Eventt = /** @class */ (function (_super) {
    ...
    Eventt.prototype.getdes = function () {
        return " <div class=\"card col-12 col-sm-12 col-md-5 col-lg-3 my-2\">\n\t\t\t\t\t\t\t\t\t <img class=\"card-img-top m-2 pr-3\" src=\"" + this.img + "\">\n\t\t\t\t\t\t\t\t \t\t<div class=\"card-body\">\n\t\t\t\t\t\t\t\t\t\t<h4 class=\"card-title\">" + this.name + "</h4>\n\t\t\t\t\t\t\t\t\t\t<p class=\"card-text\">" + this.eventDate + " " + this.eventTime + " <br>" + this.price + " $\n\t\t\t\t\t\t\t\t\t\t</p>\n\t\t\t\t\t\t\t\t\t </div>\n                    <a href=\"#!\" class=\"btn btn-info mb-2\">show me more!</a>\n\t\t\t\t\t\t\t </div>";
    };
    return Eventt;
}(Restaurant));
var items = [new Locationn("Vienna", 1010, "St.Charles Karlsplatz 1", "imgs/img1.jpg"),
    ...
    new Restaurant("vienna", 1150, "Stutterheimstrasse 6", "imgs/img6.jpg", "BioFrische", "Indian", "+43(1)9529215", "biofrische.wien"),
    new Eventt("vienna", 1010, "Seilerstaette 9", "imgs/img4.jpg", "Cats- The Musical", "Indian", "+43(1)9529215", "http://catsmusical.at", "Fr., 15.12.2020", "20:00", 120),
    new Eventt("vienna", 1020, "Ernst-Happel Stadion, Meiereistrasse 7", "imgs/img5.jpg", "Guns 'n Roses", "Indian", "+43(1)9529215", "www.gunsandroses.com/", "Sat, 09.06.2020", "19:30", 95)];
